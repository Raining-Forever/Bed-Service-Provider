          ...
          <div className={styles.appdetail}>
            <div className={styles.wraptext}>
              <div className={styles.text}>
                แพทย์ผู้ให้คำปรึกษา :{"  นพ. ขยัน เก่งมาก"}
              </div>
              <div className={styles.text}>วันที่ปรึกษา : {"1/9/2564"}</div>
              <div className={styles.text}>ช่วงเวลาปรึกษา :{"15.00-15.30"}</div>
            </div>
            <div>
              <Button type="primary">เข้าห้องประชุม</Button>
            </div>
          </div>
        </div>
      </div>
