...
export default function Form1(props) {
  ...
  function onFinish(values) {
    ...
    const result = get(values, "Q1_1", []).map(
      (v) => score_map[v]
    );
    ...
    const result2_2 = get(values, "Q2_2", []).map(
      (v) => score_map[v]
    );
          ...
          <Form name="Q1_Q2" onFinish={onFinish}>
            <div className={styles.first}>
              <h3>
                ...
                ในช่วง 14 วันที่ผ่านมา
                (หากไม่มีอาการ
                ไม่ต้องทำเครื่องหมายใดๆ)
              </h3>
              <Form.Item name="Q1_1">
                <Checkbox.Group
                  className={
                    styles.first_checkbox
                  }
                >
                  <div>
                    <Checkbox
            ...
            <div className={styles.second}>
              <h3>
                ส่วนที่ 2
                ท่านมีภาวะโรคประจำตัวนี้หรือไม่
                (หากไม่มีอาการไม่ต้องทำเครื่องหมายใดๆ)
              </h3>
              <Form.Item name="Q2_1">
                <Checkbox.Group
                  className={styles.subsecond}
                >
                  <Checkbox
                    className={
                      styles.main_checkbox
                    }
                    id="2_1"
                    value="2_1"
                    onChange={() =>
